...
public enum WarzoneConfig {
	...
	ENTRYALLOW (Boolean.class, "Entry Allow", "If true, players can enter the warzone's area without joining a team"),
	...
	NOLOBBY (Boolean.class, "No Lobby", "If true, no lobby will be created"),
